...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 12 jun 2023 kl 12:04
...
(2, 'pants', '2023-05-29'),
(3, 't-shirts', '2023-06-08'),
(5, 'jackets', '2023-06-08'),
(6, 'shoes', '2023-06-08'),
(7, 'shirts', '2023-06-08');
...
(4, 'Jeans', 1, 2, 300, 1, '2023-05-29', '2023-05-30'),
(6, 'byxor', 1, 2, 250, 1, '2023-05-30', '2023-06-05'),
(7, 'jeans', 1, 2, 100, 2, '2023-06-01', '2023-06-02'),
(75, 'adidas t-shirt', 2, 3, 100, 3, '2023-06-12', '2023-06-12');
...
(1, 'Sergejs', 'Voronins', 's@v.se', '0720801071', '2023-05-29'),
(2, 'Lisa', 'Johnsson', 'l@j.se', '075835050', '2023-05-29'),
(3, 'Carl', 'Sylvan', 'c@s.se', '0762030945', '2023-05-30'),
(4, 'Marta', 'Bengtsson', 'm@b.se', '0720254100', '2023-05-31'),
(7, 'Joanna', 'Wellington', 'j@w.se', '0720245800', '2023-06-02'),
(36, 'Göran', 'Larsson', 'g@l.se', '0720245834', '2023-06-07');
...
(1, 'XS', 'extra small', '2023-05-29'),
(2, 'S', 'small', '2023-06-08'),
(3, 'M', 'medium', '2023-06-08'),
(4, 'L', 'large', '2023-06-08');
